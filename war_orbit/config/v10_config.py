...
class V10Config:
    ...
    target_active_fronts: float = 2.2
    four_p_front_budget: float = 2.1
    front_budget_opening_4p: float = 2.5
    front_budget_midgame_4p: float = 2.0
    front_budget_late_4p: float = 1.6
    target_backbone_turn_frac: float = 0.22
    front_penalty_weight: float = 0.16
    front_penalty_cap: float = 0.32
    front_ok_bonus: float = 0.060
    front_partial_bonus: float = 0.040
    backbone_penalty_weight: float = 0.34
    backbone_bonus_weight: float = 0.32
    front_pressure_plan_bias: float = 0.16
    front_pressure_attack_penalty: float = 0.22
    front_open_penalty_weight: float = 0.26
    front_close_bonus_weight: float = 0.12
    front_overlap_penalty_weight: float = 0.28
    ...
    train_state_perturbation: float = 0.080
    eval_every: int = 1
    ...
    holdout_eval_games_train_only: int = 8
    train_only_benchmark_every: int = 3
    train_only_benchmark_games: int = 16
