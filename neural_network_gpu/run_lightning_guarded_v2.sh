...
RUN_NAME="gpu_2p_lightning_guarded_v2"
...
python "$RUNNER_PATH" \
  ...
  --ppo-epochs 3 \
  --n-players 2 \
  --simple-opponents "random,random,greedy,greedy,greedy,greedy,greedy,greedy,starter,starter,starter,starter,starter,starter,starter,starter,distance,distance,distance,distance" \
