"""Orbit Wars submission — standalone V8.2.

Generated from bot_v7.py + bot_v8_2.py so the Kaggle submission entry point
matches bot_v8_2.agent while remaining single-file/self-contained.
"""
...
# ---------------------------------------------------------------------------
# V8.2 standalone compatibility layer
# ---------------------------------------------------------------------------
