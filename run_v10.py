#!/usr/bin/env python3
"""Train and evaluate the V10 War Orbit agent."""

from __future__ import annotations

import argparse
from war_orbit.agents.v10.policy import V10Weights, load_checkpoint, get_weights
from war_orbit.config.v10_config import V10Config
...
from war_orbit.training.v10_trainer import V10Trainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--four-player-ratio", type=float, default=0.95)
    parser.add_argument("--eval-four-player-ratio", type=float, default=1.0)
    parser.add_argument("--benchmark-four-player-ratio", type=float, default=1.0)
    ...
    parser.add_argument("--min-promotion-benchmark-games", type=int, default=48)
    parser.add_argument("--benchmark-progress-every", type=int, default=1)
    parser.add_argument("--min-benchmark-score", type=float, default=0.30)
    parser.add_argument("--max-generalization-gap", type=float, default=0.16)
    parser.add_argument("--seed", type=int, default=9009)
    parser.add_argument("--checkpoint", default="evaluations/v10_4p_latest.npz")
    parser.add_argument("--best-checkpoint", default="evaluations/v10_4p_best.npz")
    parser.add_argument("--export-checkpoint", default="evaluations/v10_4p_policy.npz")
    parser.add_argument("--log-jsonl", default="evaluations/v10_4p_train.jsonl")
    ...
    parser.add_argument("--opening-punch-turns", type=int, default=65)
    ...
    parser.add_argument("--guardian-min-benchmark-4p", type=float, default=0.50)
    parser.add_argument("--guardian-min-benchmark-backbone", type=float, default=0.14)
    parser.add_argument("--guardian-max-benchmark-fronts", type=float, default=2.8)
...
def main() -> None:
    ...
    weights = V10Weights.defaults()
    if not args.skip_training:
        trainer = V10Trainer(config, resume=not args.no_resume)
