...
$logPath = Join-Path $logDir "v9_backbone_60min_$stamp.log"
...
$arguments = @(
    ...
    '--front-ok-bonus', '0.060',
    '--front-partial-bonus', '0.030',
    '--backbone-penalty-weight', '0.110',
    '--backbone-bonus-weight', '0.085',
    '--front-pressure-plan-bias', '0.14',
    '--front-pressure-attack-penalty', '0.12',
    '--exploration-rate', '0.06',
    '--reward-noise', '0.010',
    '--pool-limit', '15',
    '--checkpoint', 'evaluations\v9_backbone_60m_latest.npz',
    '--best-checkpoint', 'evaluations\v9_backbone_60m_best.npz',
    '--export-checkpoint', 'evaluations\v9_backbone_60m_policy.npz',
    '--log-jsonl', 'evaluations\v9_backbone_60m_train.jsonl',
    '--train-opponents'
) + $trainOpponents
...
Write-Host "[run_v9_backbone_60min] starting | workers=8 | train_opponents=$($trainOpponents.Count) | target_bb=0.15 | front_target=2.0 | log=$logPath"
